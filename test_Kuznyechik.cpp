...
int main() {
	...
	std::cout << "Success." << std::endl;
	std::cout << "Key scheduler functional." << std::endl;
	std::cout << "***********************" << std::endl;
	...
	assert(crypter.encrypt(BinNum("1122334455667700ffeeddccbbaa9988", 128, 16), BinNum("8899aabbccddeeff0011223344556677fedcba98765432100123456789abcdef", 256, 16)) == BinNum("7f679d90bebc24305a468d42b9d4edcd", 128, 16));
	std::cout << "Success." << std::endl;
	...
	std::cout << "Key: 8899aabbccddeeff0011223344556677fedcba98765432100123456789abcdef" << std::endl;
	std::cout << "Testing case: ";
	assert(crypter.decrypt(BinNum("7f679d90bebc24305a468d42b9d4edcd", 128, 16), BinNum("8899aabbccddeeff0011223344556677fedcba98765432100123456789abcdef", 256, 16)) == BinNum("1122334455667700ffeeddccbbaa9988", 128, 16));
	std::cout << "Success." << std::endl;
